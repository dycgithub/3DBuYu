...
namespace _Project.UI.Item
{
    ...
    public class PortInventoryGridPanel : _Project.UI.Inventory.InventoryGridView
    {
        public void Initialize(PortInventory inventory) => Initialize((IInventory)inventory);
    }
}
